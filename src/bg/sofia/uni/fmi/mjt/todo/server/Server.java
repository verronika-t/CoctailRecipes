        ...
        try (ServerSocketChannel serverSocketChannel = ServerSocketChannel.open()) {
            ...
            while (isServerWorking) {
                try {
                    ...
                    writeClientOutput(client,  String.format("{\"status\":\"ERROR\"\"errorMesage\":\"%s\":}", e.getMessage()));
                  //  System.out.printf("{\"status\":\"ERROR\"\"errorMesage\":\"%s\":}", e.getMessage());
            ...
            throw new UncheckedIOException("failed to start bg.sofia.uni.fmi.mjt.todo.server", e);
        }
    }
